<?php 
	...
	main_header();
		print '<input type="hidden" id="marker" value="index.php">';

		print '<div style="margin-top: 50px; background-color: #ffffff; z-index: 100; position: absolute; padding: 5px; border: 1px solid black; right: 0px; top: 0px; height: 100%;">';
			// Info Table
		...
		print '<div class="MainScreen">';
			...
			print '<table class="MainTable">';
				...
				// T header
				print '<tr>';
					print '<td class="list_t firstTfield">';
						print 'LBS';
					print '</td>';
					print '<td id="H1" class="list_t HeimButton" style="background: rgb(18, 177, 0); color: rgb(0, 0, 0);">';
						print 'H1';
					print '</td>';
					print '<td id="H2" class="list_t HeimButton">';
						print 'H2';
					print '</td>';
					print '<td id="H3" class="list_t HeimButton">';
						print 'H3';
					print '</td>';
				...
				// T Left
				print '<tr>';
					print '<td id="SE" class="list_t StockwerkButton" style="background: rgb(18, 177, 0); color: rgb(0, 0, 0);">';
						print 'E';
					print '</td>';
					// Heim Bild
					print '<td rowspan="4" colspan="4" class="HeimScreen" id="HeimScreen">';
						...
						print '<div style="position: relative;">';
							print '<img id="heimimage" style="top: 0; left: 0;" src="heimstockwerke/H1S1.png" class="HeimStockwerkBild" usemap="#roommap">';
				...
				print '<tr>';
					print '<td id="S1" class="list_t StockwerkButton">';
						print '1';
					print '</td>';
				print '</tr>';

				print '<tr>';
					print '<td id="S2" class="list_t StockwerkButton">';
						print '2';
					print '</td>';
				print '</tr>';
